...
def main():
    ...
    parser.add_argument("--raw_dir", type=str, default="data/raw/db_27_0_excel", help="原始数据目录路径")
    parser.add_argument("--output_dir", type=str, default="data/processed", help="输出目录路径")

    args = parser.parse_args()

    # 确保路径是相对于项目根目录的
    raw_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../", args.raw_dir))
