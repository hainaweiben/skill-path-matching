...
def main():
    ...
    # 加载数据集
    logger.info("加载数据集...")
    train_dataset = SkillMatchingDataset(data_dir=config["data"]["data_dir"], split="train", transform=None)

    val_dataset = SkillMatchingDataset(data_dir=config["data"]["data_dir"], split="val", transform=None)
